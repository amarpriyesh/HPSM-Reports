...
recipient="Amr.Sorour@du.ae,Rajashree.Bhatt@du.ae,Amer.Radwan@du.ae,Moatasem.Salama@du.ae,John.Mathew@du.ae,Mohamed.Alshemsi@du.ae,Shadi.Trad@du.ae,Kareem.AlQady@du.ae,Shyam.Nath@du.ae,Mohammad.Rasheed@du.ae,Muhammad.Yaseen@du.ae,LaxmaReddy.Kompally@du.ae,sandeep.gupta@du.ae,sanjay.sharma@du.ae,ankur.saxena@du.ae,Gagan.Atreya@du.ae,Rishi.Ghai@du.ae,utkarsh.jauhari@du.ae,ITOperationsEricssonOnsiteApps@du.ae"
recipient1="Ibrahim.Jebai@du.ae,Ibrahim.AlHammadi@du.ae,Rehan.Yasin@du.ae,Kapil.Kalra@du.ae,Neeraj.Sharma@du.ae,Tamer.Awad@du.ae"
...
where a.problem_status in('Open','Accepted','In Progress','Pending Input','Rejected','ReAssigned','Reopened') and (upper(a.assignment) in ('IT - BSCS (BILLING) - DEV','IT - BSS STREAMSERVE - DEV','IT - BSS POWERBILL - DEV','IT - BSS IN - DEV','DCS - DEV','IT - BSS STRONGMAIL - DEV','IT - PAYMENT GATEWAY - DEV','IT - POS - DEV','RA - MONETA - DEV','IT - ICS - DEV','IT - SIEBEL (CRM) – ATOS','IT - OMP - DEV','IT DSP DEV','IT - ESS MNMI - DEV','IT - EAI - DEV','IT - OSS-DEV-FIXED PROVISIONING','IT - OSS-DEV-MOBILE PROVISIONING','IT - OSS-DEV-MOBILE MEDIATION','IT - GIS - DEV','IT - OSS-DEV-OAIM','IT - OSS-DEV-NPG','MSDP - DEV','IT - DEV - IDASHBOARDS','IT - OSS-DEV- HPSM','CAMPAIGN MANAGEMENT - DEV','IT - EDMS - DEV','IT - ESS DUVERSE - DEV','IT - DATAWAREHOUSE - DEV','CUSTOMER PROFITABILITY - DEV','IT - ICM DEV','IT - ERP - DEV','IT - DEV - INTRANET','IT - EBUSINESS - DEV','DQ - DEV','UCM - DEV','IT - IWV - DEV','IT - ESS MOI - DEV') or a.assignment like '%Ops L3%' or assignment like 'IT - Siebel (CRM)%Atos') and open_time>='01-NOV-2015';
spool off;
quit;
EOF
