...
((close_time+4/24 >= trunc(trunc(sysdate,'DD')-10) and 
...
echo "."| mail -v -s " TT Report for `date`" -a /hpsm/hpsm/ops/reports/SiebelHPSMIncidents_Weekly$datestr.txt.gz ankur.saxena@du.ae
#(echo "Please find attached Weekly Siebel HPSM Incidents report"; uuencode SiebelHPSMIncidents_Weekly$datestr.txt.gz SiebelHPSMIncidents_Weekly$datestr.txt.gz)| mailx -s " TT Report for `date`" "ankur.saxena@du.ae"
i
