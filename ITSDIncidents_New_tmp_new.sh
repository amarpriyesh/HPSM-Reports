...
set feedback off
set echo off
spool ITSDIncident_2018$datestr.txt
...
from probsummarym1 
where assignment like '%IT%' and (open_time>=to_date('01/07/2018 00:00:00','dd/mm/yyyy hh24:mi:ss') ) and folder not in ('FMS','TSRM');
spool off;
quit;
EOF
gzip ITSDIncident_2018$datestr.txt
/usr/bin/smbclient \\\\10.175.67.50\\Public\$ -A .passwd.txt -c "cd \"HPSM Reports\new report\"; lcd /hpsm/hpsm/ops/; prompt; recurse; mput ITSDIncident_2018$datestr.txt.gz; exit;"
