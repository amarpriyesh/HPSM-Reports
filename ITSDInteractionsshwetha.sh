...
B.source=C."NUMBER"(+) and  (A.open_time+4/24>='01-Feb-2020');
spool off;
quit;
EOF
...
echo "."| mail -v -s "Please find attached ITSD Interaction TT report" -a /hpsm/hpsm/ops/reports/ITSDInteraction$datestr.txt.gz priyesh.a@du.ae,Shwetha.Ranjini@du.ae,shadi.trad@du.ae
