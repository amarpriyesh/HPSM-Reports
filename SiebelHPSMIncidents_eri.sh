...
from 
probsummarym1
where folder = 'SIEBEL-CRM' and (close_time+4/24) between to_date('01/09/2014 00:00:00','dd/mm/yyyy hh24:mi:ss') and 
to_date('01/10/2014 00:00:00','dd/mm/yyyy hh24:mi:ss') or (resolved_time+4/24) between to_date('01/09/2014 00:00:00','dd/mm/yyyy hh24:mi:ss') and
