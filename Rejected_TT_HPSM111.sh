...
b.datestamp < to_date('01/03/2016 00:00:00','dd/mm/yyyy hh24:mi:ss')
...
|| '|' ||''
 ...
 WHERE k."NUMBER" = b."NUMBER" AND k.TYPE = 'Open' and B.datestamp > to_date('01/03/2016 00:00:00','dd/mm/yyyy hh24:mi:ss')
