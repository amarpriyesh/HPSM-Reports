...
from probsummarym1
where (close_time+4/24 >=to_date('01/04/2017 00:00:00','dd/mm/yyyy hh24:mi:ss') or problem_status<>'Closed')
and (folder='ITSD'
...
echo "."| mail -v -s "Please find attached ITSD Dealer TT report" -a /hpsm/hpsm/ops/reports/ITSD_Dealer_TSRM_TT$datestr.txt.gz ankur.saxena@du.ae
