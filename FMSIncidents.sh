...
where (folder in('FMS','I&W') and "NUMBER" not in ('IM4606547', 'IM4604234','IM5200693') and (close_time>to_date('01/04/2019 00:00:00','dd/mm/yyyy hh24:mi:ss') or problem_status<>'Closed'));
