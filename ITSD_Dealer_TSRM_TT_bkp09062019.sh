...
from probsummarym1 
where (close_time+4/24 >=to_date('01/12/2018 00:00:00','dd/mm/yyyy hh24:mi:ss') or problem_status<>'Closed')
and (folder='ITSD'
...
/usr/bin/smbclient \\\\172.21.15.11\\HPSMFilesShareFolder -A .passwd_new.txt -c "lcd /hpsm/hpsm/ops/reports/ ; prompt; recurse; mput ITSD_Dealer_TSRM_TT$datestr.txt.gz; exit;"
