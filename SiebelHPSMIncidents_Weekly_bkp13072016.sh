...
/usr/bin/smbclient \\\\10.175.67.50\\Public\$ -A .passwd.txt -c "cd \"HPSM Reports\Siebel HPSM Reports\"; lcd /hpsm/hpsm/ops/reports; prompt; recurse; mput SiebelHPSMIncidents_Weekly$datestr.txt.gz; exit;"