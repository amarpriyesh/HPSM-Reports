...
from probsummarym1 
where (open_time+4/24 >=to_date('01/05/2018 00:00:00','dd/mm/yyyy hh24:mi:ss') and open_time+4/24 <to_date('01/08/2018 00:00:00','dd/mm/yyyy hh24:mi:ss'))
and (folder='ITSD'
...
echo "."| mail -v -s "Please find attached ITSD Dealer TT report" -a /hpsm/hpsm/ops/reports/ITSD_Dealer_TSRM_TT$datestr.txt.gz Shwetha.Ranjini@du.ae,priyesh.a@du.ae
