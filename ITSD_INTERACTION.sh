...
recipient="ramakrishnan.m@du.ae,preem.kumar@du.ae,Karthik.Reddy@du.ae,Rameya.Jeyakumar@du.ae,Shwetha.Ranjini@du.ae,Nandini.Nagaraju@du.ae,Edward.Paul@du.ae,Nareen.Shaganti@du.ae,Praveen.Naidu@du.ae,Praveen.Singu@du.ae,Hari.Mandadapu@du.ae,Winner.Viagularaj@du.ae,Mohitha.Ambati@du.ae,Sankar.Kotla@du.ae,Mansoor.A@du.ae,Midhun.Antony@du.ae,Pratheek.Reddy@du.ae,mugtaba.ahmed@du.ae,Sofia.Begum@du.ae,Madhuri.J@du.ae,Mohamed.Imam@du.ae,Iqbal.Khan@du.ae,Kavitha.Rajput@du.ae"
...
then
cd /usr/sbin/
/usr/sbin/sendmail -t < /hpsm/hpsm/ops/MC_report
fi
#exit 0
