...
recipient="ITBillingApplicationSupport@du.ae,priyesh.a@du.ae,Rahul.Gupta1@du.ae,Hemanta.Patra@du.ae,marwan.abdoh@du.ae,Sanjay.Sharma@du.ae,yasir.khattak1@du.ae,Ratnesh.Jain@du.ae,Ilika.Srivastava@du.ae,Deepak.Kumar1@du.ae,Sandeep.Gupta@du.ae,Shailey.Narula@du.ae,Mayank.Srivastava@du.ae,Goldy.Kumar@du.ae,Gaurav.Gupta@du.ae,Rahul.Maheshwari@du.ae,Priyanka.Jain@du.ae,Nagendra.Singh@du.ae,Rajashree.Bhatt@du.ae,Amer.Radwan@du.ae,Moatasem.Salama@du.ae,Ashish.Pandita@du.ae,John.Mathew@du.ae,Mohamed.Alshemsi@du.ae,Beethin.Chakraborty@du.ae,Shahid.Bashir@du.ae,Shadi.Trad@du.ae,Kareem.AlQady@du.ae,Shyam.Nath@du.ae,Mohammad.Rasheed@du.ae,Muhammad.Yaseen@du.ae,LaxmaReddy.Kompally@du.ae,sandeep.gupta@du.ae,sanjay.sharma@du.ae,ankur.saxena@du.ae,Gagan.Atreya@du.ae,utkarsh.jauhari@du.ae,lalit.gupta@du.ae,lakshmi.thevar@du.ae,Leelandra.Sunnam@du.ae,Ranga.Modadugu1@du.ae,ITOperationsEricssonOnsiteApps@du.ae"
...
where a.problem_status in('Open','Accepted','In Progress','Pending Input','Rejected','ReAssigned','Reopened') and (upper(a.assignment) in ('SD_CPE','IT - BSCS (BILLING) - DEV','IT - BSS STREAMSERVE - DEV','IT - BSS POWERBILL - DEV','IT - BSS IN - DEV','DCS - DEV','IT - BSS STRONGMAIL - DEV','IT - PAYMENT GATEWAY - DEV','IT - POS - DEV','RA - MONETA - DEV','IT - ICS - DEV','IT - SIEBEL (CRM) – ATOS','IT - OMP - DEV','IT DSP DEV','IT - ESS MNMI - DEV','IT - EAI - DEV','IT - OSS-DEV-FIXED PROVISIONING','IT - OSS-DEV-MOBILE PROVISIONING','IT - OSS-DEV-MOBILE MEDIATION','IT - GIS - DEV','IT - OSS-DEV-OAIM','IT - OSS-DEV-NPG','MSDP - DEV','IT - DEV - IDASHBOARDS','IT - OSS-DEV- HPSM','CAMPAIGN MANAGEMENT - DEV','IT - EDMS - DEV','IT - ESS DUVERSE - DEV','IT - DATAWAREHOUSE - DEV','CUSTOMER PROFITABILITY - DEV','IT - ICM DEV','IT - ERP - DEV','IT - DEV - INTRANET','IT - EBUSINESS - DEV','DQ - DEV','UCM - DEV','IT - IWV - DEV','IT - ESS MOI - DEV','IT BSS Ops L4 TT','IT ESS Ops L4 TT','IT OSS Ops L4 TT') or a.assignment like '%Ops L3%' or assignment like 'IT - Siebel (CRM)%Atos' or assignment in ('FNL_DEV','FNL_OPs','FNL_SDM')) and open_time>='01-NOV-2015';
spool off;
quit;
EOF
