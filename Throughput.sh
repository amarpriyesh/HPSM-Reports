...
where b.datestamp+4/24 >= to_date('01/12/2015 00:00:00','DD/MM/YYYY HH24:MI:SS') and
...
echo "."| mail -v -s "Weekly Throughput report `date`" -a /hpsm/hpsm/ops/AS_Throughput_Test$datestr.txt ankur.saxena@du.ae
