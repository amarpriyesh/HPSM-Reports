...
||'|'||a.assignee_name
||'|'||b.operator
from probsummarym1 a,activitym1 b where a."NUMBER"=b."NUMBER" and b.type='Reopened' and b.datestamp>= to_date('01/03/2016 00:00:00','dd/mm/yyyy HH24:MI:SS');
spool off;
quit;
EOF
...
(echo "Please find attached the Reopened Incidents report"; uuencode Incidents_Reopened_HPSM$datestr.txt.gz Incidents_Reopened_HPSM$datestr.txt.gz)| mailx -s
 "HPSM Reopened Incidents Report for `date`" "nihalchand.dehury@du.ae"
