...
echo "."| mail -v -s " NOC Throughput Daily Report for `date`" -a /hpsm/hpsm/ops/reports/NOC_Throughput_Daily$datestr.csv.gz MuhammadImran.Khan@du.ae,Michael.Milad@du.ae,Jamal.SheikDawood@du.ae
#(echo "Please find attached TT report"; uuencode NOC_Throughput_Daily$datestr.csv.gz NOC_Throughput_Daily$datestr.csv.gz)| mailx -s " NOC Throughput Daily Report for `date`" "mohammed.rezwanali@du.ae,MuhammadImran.Khan@du.ae,Michael.Milad@du.ae,Jamal.SheikDawood@du.ae"
