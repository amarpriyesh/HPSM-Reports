...
MailSubject="All Open AS & IS TT Report @25th Feb
...
select case when incidents > 0 then   '<tr><td>'||b.Name||'</td><td align=center>'|| nvl(Zero,0)||'</td><td align=center>'||nvl(One,0)||'</td><td align=center>'||nvl(Two,0)||'</td><td align=center>'|| nvl(Three,0)||'</td><td align=center>'|| nvl(four,0)||'</td><td align=center>'|| nvl(five,0)||'</td><td align=center>'|| nvl(six_ten,0)||'</td><td align=center>'|| nvl(greater_ten,0)||'</td><th>'||to_char( nvl(incidents,0))||'</th></tr>' else null end From (select  Assignment, sum(Zero) Zero,sum(One) One,sum(Two) Two,sum(Three) Three,sum(Four) Four,sum(Five) Five,sum(six_ten) six_ten,sum(greater_ten) greater_ten,sum(incidents) incidents from (
  ...
  , 1 Incidents
from HPSM94BKPADMIN.Probsummarym1
 where PROBLEM_STATUS not in ('Resolved','Closed','Rejected to Business','Pending Input') and folder in ('ITSD') and category not in ('FMS') and du_master_tt is NULL) group by Assignment) a right join (select distinct name from HPSM94BKPADMIN.AssignmentA1 where (name in ('IT SMS GW','KMUCC Support','IT - DB Systems (L1)','RSS Support Group','IT - SAN (L1)','IT - Unix System (L1)','IT - BSCS Provisioning','IT - Technical Hardware Support (Jumbo Support)','IT - Dealer Hardware Support (Jumbo Support)','IAM Operations','IT - 2FA','FNL_OPs','DuVerse Access','IT - MNP Application Support','ITOC-Execution-IN','ITOC-Execution-Infra','ITOC-Execution-Apps','IT - Business Application Access','IT - Billing','IT DSP Application Support','IT - Interconnect Billing','IT - DB SAN UNIX Systems (L1)','IT - Enterprise Systems (L1)','NOC - IN','Bill Shock','Core - Mobile IN','IT-SQL DBA','IT - GIS','IT - ICS','IT - OSS-OPS-Fixed Mediation','IT - OSS-OPS-Mobile Mediation','IT - Corporate Technical Support Onshore','ITOC - User Access Management','IT- Payment Gateway','IT - POS','IT - Payment Gateway','IT - Datawarehouse','IT - ERP','IT - EAI','IT - EBusiness','IT - OSS-OPS-Fault/Performance MGMT','IT - OSS-OPS- HPSM','IT - OSS-OPS-Mobile Provisioning','IT - OSS-OPS-Network Core Services','IT - OSS-OPS-OAIM','IT - CRM','IT - Backup Admin','IT Enterprise Services & Support','IT - System Admin UNIX','IT - Database Admin','IT - System Admin WINDOWS','IT - Enterprise Systems (HMC)','IT - SAN Admin','IT - NOC','IT - EDMS','IT - Mission Critical Enterprise Systems & Service','IN Infra Database','IN Infra VMware','IN Infra Unix','IT - Desktop & System Support','IT - Citrix Support','IT - Security','IT - Sharepoint','IT - IP TV') or name like '%L2%' or name like 'IN Infra Storage%'))b on a.Assignment=b.Name order by B.Name;
exit;
EOF
...
select case when incidents > 0 then   '<tr><td>'||b.Name||'</td><td align=center>'|| nvl(Zero,0)||'</td><td align=center>'||nvl(One,0)||'</td><td align=center>'||nvl(Two,0)||'</td><td align=center>'|| nvl(Three,0)||'</td><td align=center>'|| nvl(four,0)||'</td><td align=center>'|| nvl(five,0)||'</td><td align=center>'|| nvl(six_ten,0)||'</td><td align=center>'|| nvl(greater_ten,0)||'</td><th>'||to_char( nvl(incidents,0))||'</th></tr>' else null end From (select  Assignment, sum(Zero) Zero,sum(One) One,sum(Two) Two,sum(Three) Three,sum(Four) Four,sum(Five) Five,sum(six_ten) six_ten,sum(greater_ten) greater_ten,sum(incidents) incidents from (
  ...
  , 1 Incidents
from HPSM94BKPADMIN.Probsummarym1
 where PROBLEM_STATUS  in ('Pending Input') and folder in ('ITSD') and category not in ('FMS') and du_master_tt is NULL) group by Assignment) a right join (select distinct name from HPSM94BKPADMIN.AssignmentA1 where (name in ('IT SMS GW','IT - MNP Application Support','KMUCC Support','DuVerse Access','FNL_OPs','IT - BSCS Provisioning','RSS Support Group','IT - DB Systems (L1)','IT - SAN (L1)','IT - Unix System (L1)','ITOC-Execution-IN','ITOC-Execution-Infra','ITOC-Execution-Apps','IT - Business Application Access','IT - Technical Hardware Support (Jumbo Support)','IAM Operations','IT - 2FA','IT - Billing','IT DSP Application Support','IT - DB SAN UNIX Systems (L1)','IT - Enterprise Systems (L1)','NOC - IN','IT - Interconnect Billing','Bill Shock','Core - Mobile IN','IT-SQL DBA','IT - GIS','IT - ICS','IT - OSS-OPS-Fixed Mediation','IT - OSS-OPS-Mobile Mediation','IT - Corporate Technical Support Onshore','ITOC - User Access Management','IT- Payment Gateway','IT - POS','IT - Payment Gateway','IT - Datawarehouse','IT - ERP','IT - EAI','IT - EBusiness','IT - OSS-OPS-Fault/Performance MGMT','IT - OSS-OPS- HPSM','IT - OSS-OPS-Mobile Provisioning','IT - OSS-OPS-Network Core Services','IT - OSS-OPS-OAIM','IT - CRM','IT - Backup Admin','IT Enterprise Services & Support','IT - System Admin UNIX','IT - Database Admin','IT - System Admin WINDOWS','IT - Enterprise Systems (HMC)','IT - SAN Admin','IT - NOC','IT - EDMS','IT - Mission Critical Enterprise Systems & Service','IN Infra Database','IN Infra VMware','IN Infra Unix','IT - Desktop & System Support','IT - Citrix Support','IT - Security','IT - Sharepoint','IT - IP TV') or name like '%L2%' or name like 'IN Infra Storage%'))b on a.Assignment=b.Name order by B.Name;
exit;
EOF
...
(select  Assignment, sum(Zero) Zero,sum(One) One,sum(Two) Two,sum(Three) Three,sum(Four) Four,sum(Five) Five,sum(six_ten) six_ten,sum(greater_ten) greater_ten,sum(incidents) incidents from (
  ...
  , 1 Incidents
from HPSM94BKPADMIN.Probsummarym1
where PROBLEM_STATUS not in ('Resolved','Closed','Rejected to Business')  and category in ('FMS') and du_master_tt is NULL) group by Assignment) a right join (select distinct name from HPSM94BKPADMIN.AssignmentA1 where (name in ('IT SMS GW','DuVerse Access','IT - MNP Application Support','KMUCC Support','FNL_OPs','ITOC-Execution-IN','IT - BSCS Provisioning','RSS Support Group','ITOC-Execution-Infra','ITOC-Execution-Apps','IT - DB Systems (L1)','IT - SAN (L1)','IT - Unix System (L1)','IT - Business Application Access','IT - Billing','IT DSP Application Support','IT - DB SAN UNIX Systems (L1)','IT - Enterprise Systems (L1)','NOC - IN','IT - Interconnect Billing','Bill Shock','IT - Technical Hardware Support (Jumbo Support)','IAM Operations','IT - 2FA','Core - Mobile IN','IT-SQL DBA','IT - GIS','IT - ICS','IT - OSS-OPS-Fixed Mediation','IT - OSS-OPS-Mobile Mediation','IT - Corporate Technical Support Onshore','ITOC - User Access Management','IT- Payment Gateway','IT - POS','IT - Payment Gateway','IT - Datawarehouse','IT - ERP','IT - EAI','IT - EBusiness','IT - OSS-OPS-Fault/Performance MGMT','IT - OSS-OPS- HPSM','IT - OSS-OPS-Mobile Provisioning','IT - OSS-OPS-Network Core Services','IT - OSS-OPS-OAIM','IT - CRM','IT - Backup Admin','IT Enterprise Services & Support','IT - System Admin UNIX','IT - Database Admin','IT - System Admin WINDOWS','IT - Enterprise Systems (HMC)','IT - SAN Admin','IT - NOC','IT - EDMS','IT - Mission Critical Enterprise Systems & Service','IN Infra Database','IN Infra VMware','IN Infra Unix','IT - Desktop & System Support','IT - Citrix Support','IT - Security','IT - Sharepoint','IT - IP TV') or name like '%L2%' or name like 'IN Infra Storage%')) b on a.Assignment=b.Name order by B.Name;
...
where a.problem_status not in('Rejected to Business','Closed','Resolved') and a.du_master_tt is NULL and  (a.Assignment in ('IT SMS GW','DuVerse Access','ITOC-Execution-IN','ITOC-Execution-Infra','ITOC-Execution-Apps','IT - MNP Application Support','IT - Business Application Access','IT - Billing','IT - Corporate Technical Support Onshore','KMUCC Support','FNL_OPs','RSS Support Group','IT - BSCS Provisioning','ITOC - User Access Management','NOC - IN','Bill Shock','Core - Mobile IN','IT - DB Systems (L1)','IT - SAN (L1)','IT - Unix System (L1)','IT-SQL DBA','IT - GIS','IT - ICS','IT - OSS-OPS-Fixed Mediation','IT - OSS-OPS-Mobile Mediation','IT - Interconnect Billing','IT - Payment Gateway','IT - POS' ,'IT - Datawarehouse','IT - ERP','IT - EAI','IT DSP Application Support','IT - EBusiness','IT - OSS-OPS-Fault/Performance MGMT','IT - Technical Hardware Support (Jumbo Support)','IAM Operations','IT - 2FA','IT - OSS-OPS-Mobile Provisioning','IT - DB SAN UNIX Systems (L1)','IT - Enterprise Systems (L1)','IT - OSS-OPS-Network Core Services' ,'IT - OSS-OPS-OAIM' ,'IT - CRM','IT - OSS-OPS- HPSM','IT - Backup Admin','IT Enterprise Services & Support','IT - System Admin UNIX','IT - Database Admin','IT - System Admin WINDOWS','IT - Enterprise Systems (HMC)','IT - SAN Admin','IT - NOC','IT - EDMS','IT - Mission Critical Enterprise Systems & Service','IN Infra Database','IN Infra VMware','IN Infra Unix','IT - Desktop & System Support','IT - Citrix Support','IT - Security','IT - Sharepoint','IT - IP TV') or a.assignment like '%L2%' or a.assignment like 'IN Infra Storage%' );
spool off;
quit;
EOF
...
#echo "" >> $REPORTFILE_ASIS
echo "" >> $REPORTFILE_ASIS
cat all_open_tt41.csv >> $REPORTFILE_ASIS
