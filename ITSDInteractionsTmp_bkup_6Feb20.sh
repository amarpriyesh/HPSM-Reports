...
echo "."| mail -v -s "Please find attached ITSD Interaction TT report" -a /hpsm/hpsm/ops/reports/ITSDInteraction$datestr.txt.gz priyesh.a@du.ae,Mugtaba.Ahmed@du.ae,Shadi.Trad@du.ae,Waleed.Ibrahim@du.ae,omar.sherif@du.ae,Abdulrahman.Dakalbab@du.ae
