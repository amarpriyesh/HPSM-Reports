...
echo "Subject: ITSD SLA Monthly Report $fromdate-$todate" >> $sla
...
Dear All,<br /><br />Please find below ITSD SLA status for $fromdate-$todate resolved/rejected to business TTs <br />
<br /></font></P></html>" >> $sla
